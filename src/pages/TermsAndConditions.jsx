...
//             <h1 className="text-3xl md:text-4xl text-[#FFA500] mb-6">Terms & Conditions</h1>
            
//             <div className="space-y-6 font-sans text-gray-300">
//               <p className="italic">Last Updated: April 30, 2025</p>
              
//               <h2 className="text-xl md:text-2xl text-[#FFA500] mt-6 mb-2">1. Acceptance of Terms</h2>
//               <p>By accessing and using Flick N Roll's services, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions. If you do not agree to these terms, please do not use our services.</p>
              
//               <h2 className="text-xl md:text-2xl text-[#FFA500] mt-6 mb-2">2. Use of Services</h2>
//               <p>Our pickleball courts and facilities are available for use according to our scheduling system. Users must respect court time limits, facility rules, and the rights of other players. Inappropriate behavior, including but not limited to abusive language, physical altercations, or damage to property will not be tolerated and may result in removal from the premises and cancellation of membership.</p>
              
//               <h2 className="text-xl md:text-2xl text-[#FFA500] mt-6 mb-2">3. Booking and Payments</h2>
//               <p>Court bookings must be made through our official booking system. Payment is required at the time of booking. We accept major credit cards and digital payment methods. All sales are final subject to our cancellation policy.</p>
              
//               <h2 className="text-xl md:text-2xl text-[#FFA500] mt-6 mb-2">4. Liability</h2>
//               <p>Players use our facilities at their own risk. Flick N Roll is not responsible for any injuries, accidents, or loss of personal property that may occur while using our facilities. We recommend that all players have appropriate personal medical insurance and consult with a physician before engaging in physical activities.</p>
              
//               <h2 className="text-xl md:text-2xl text-[#FFA500] mt-6 mb-2">5. Changes to Terms</h2>
//               <p>We reserve the right to modify these terms at any time. Changes will be effective immediately upon posting on our website. Continued use of our services after changes constitutes acceptance of the modified terms.</p>
//             </div>
//           </div>
//         </div>

//         {/* Spinning Ball - maintained from original */}
              ...
              {[
                {
                  ...
                  content: "By accessing and using Flick N Roll's services, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions. If you do not agree to these terms, please do not use our services."
                },
                {
                  title: "2. Use of Services",
                  content: "Our pickleball courts and facilities are available for use according to our scheduling system. Users must respect court time limits, facility rules, and the rights of other players. Inappropriate behavior, including but not limited to abusive language, physical altercations, or damage to property will not be tolerated and may result in removal from the premises and cancellation of membership."
                },
                {
                  title: "3. Booking and Payments",
                  content: "Court bookings must be made through our official booking system. Payment is required at the time of booking. We accept major credit cards and digital payment methods. All sales are final subject to our cancellation policy."
                },
                {
                  title: "4. Liability",
                  content: "Players use our facilities at their own risk. Flick N Roll is not responsible for any injuries, accidents, or loss of personal property that may occur while using our facilities. We recommend that all players have appropriate personal medical insurance and consult with a physician before engaging in physical activities."
                },
                {
