    ...
    <>
      ...
      >
        ...
        <div className="container mx-auto px-4 py-24 flex-grow z-10">
          {/* Contact Card */}
          <motion.div 
            className="bg-[#1A1721]/80 backdrop-blur-sm rounded-lg shadow-xl p-6 md:p-8 max-w-4xl mx-auto text-white"
            variants={fadeInUp}
            initial="hidden"
            animate="visible"
          ...
          >
            ...
            >
              <h3 className="text-xl font-bold mb-4 text-[#FFA500] group flex items-center">
                <span className="inline-block transform group-hover:translate-x-1 transition-transform duration-300">
                  Our Location
                </span>
              </h3>
              <div className="h-[250px] md:h-[300px] w-full overflow-hidden rounded-lg border border-gray-700 mb-2 shadow-lg hover:shadow-[0_10px_30px_rgba(0,0,0,0.4)] transition-all duration-500 hover:border-[#FFA500]/20 transform hover:scale-[1.01]">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3666.9586364980028!2d72.65421789999999!3d23.208178!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395c2b595bf5c823%3A0x365c81833ae6de33!2z8J2XmfCdl5_wnZec8J2XlvCdl54gJ_Cdl6Eg8J2XpfCdl6LwnZef8J2XnyB8IPCdl5XwnZey8J2YgPCdmIEg8J2Xo_Cdl7bwnZew8J2XuPCdl7nwnZey8J2Xr_Cdl67wnZe58J2XuSDwnZec8J2XuyDwnZea8J2XrvCdl7vwnZex8J2XtfCdl7bwnZe78J2XrvCdl7TwnZeu8J2Xvw!5e0!3m2!1sen!2sin!4v1746098926197!5m2!1sen!2sin"
                  width="100%"
                  height="100%"
              ...
              <div className="flex items-center mt-2">
                <MapPin size={18} className="text-[#FFA500] mr-2" />
                <p className="text-sm text-gray-400">
                  FLICK 'N ROLL, Chh, 3, Nr. Parinam Circle, Gandhinagar, Gujarat 382009
                </p>
              </div>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-8">
              ...
              >
                {[
                  ...
                  },
                  {
                    ...
                    items: [
                      { icon: <Clock size={18} className="text-[#FFA500] mr-2" />, content: <span><span className="font-semibold">Everyday</span> - 24 x 7</span> },
                    ]
                  },
                  {
                  ...
                  >
                    <h3 className="text-xl font-bold mb-3 text-[#FFA500] group flex items-center">
                      <span className="inline-block transform group-hover:translate-x-1 transition-transform duration-300">
                        {section.title}
                      </span>
                    </h3>
                    ...
                    {section.content && (
                      <div className="ml-1 mt-2">{section.content}</div>
                    )}
                  </motion.div>
                ))}
              </motion.div>
              ...
              >
                {isSubmitted ? (
                  <motion.div 
                    className="bg-[#FFA500]/10 border border-[#FFA500]/30 text-[#FFA500] px-6 py-6 rounded-lg mb-4"
                    initial={{ opacity: 0, scale: 0.95 }}
                    animate={{ opacity: 1, scale: 1 }}
                    transition={{ duration: 0.3 }}
                  >
                    <strong className="font-bold text-xl">Thank you!</strong>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    >
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        required
                        className="w-full px-3 py-2 bg-[#2D2A3A]/50 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FFA500]/50 focus:border-[#FFA500] text-white transition-all duration-300"
                      />
                    </motion.div>
                    <motion.div
                      initial={{ opacity: 0, y: 15 }}
                    ...
                    <motion.button
                      type="submit"
                      className="w-full bg-[#FFA500] hover:bg-[#FFA500]/80 text-gray-900 font-bold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-[1.02] shadow-lg"
                      whileHover={{ y: -2 }}
                      whileTap={{ scale: 0.98 }}
                      initial={{ opacity: 0, y: 15 }}
                      animate={{ opacity: 1, y: 0 }}
