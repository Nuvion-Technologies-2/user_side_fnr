        ...
        <div className="container mx-auto px-4 py-24 flex-grow z-10">
          ...
          >
            ...
            <div className="space-y-6 font-sans text-gray-300">
              ...
              {[
                {
                  title: "Merchandise Shipping",
                  content: "For all merchandise purchased from our online store, the following shipping policies apply:"
                },
                {
                  title: "Processing Time",
                  content: "Orders are typically processed within 1-2 business days after payment confirmation. During peak seasons or promotional periods, processing may take up to 3 business days."
                },
                {
                  ...
                  list: [
                    ...
                    "Next Day Delivery (order by 12pm): $19.99",
                    "Free shipping on all orders over $75"
                  ]
                },
                {
                  title: "International Shipping",
                  content: "We currently ship to select international destinations. International shipping rates and timeframes vary by location. Additional customs fees or taxes may apply and are the responsibility of the recipient."
                },
                {
                  title: "Tracking",
                  content: "A tracking number will be provided via email once your order has been shipped. You can track your order's status by logging into your account on our website or by using the tracking number provided in the shipping confirmation email."
                },
                {
                ...
                },
                {
                  ...
                  content: "Please see our Returns Policy for information on how to return or exchange items. We offer a 30-day return policy for most items in new, unworn condition with original packaging."
                },
              ].map((section, index) => (
                <motion.div 
                  key={index}
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {[
                    ...
                    { label: "Shipping & Delivery", href: "/shipping-delivery", active: true },
                  ].map((link, index) => (
                    <motion.li key={index} whileHover={{ x: 3 }}>
                      <Link
                        to={link.href}
