  ...
  return (
    <>
      ...
      >
        ...
        {/* Content - Kept the same with adjusted padding for fixed header */}
        <div className="container mx-auto px-4 py-24 flex-grow z-10">
          <div className="bg-[#1A1721]/80 backdrop-blur-sm rounded-lg shadow-lg p-6 md:p-10 max-w-4xl mx-auto text-white">
            ...
            <div className="space-y-6 font-sans text-gray-300">
              ...
              <h2 className="text-xl md:text-2xl text-[#FFA500] mt-6 mb-2">
                1. Introduction
              </h2>
              <p>
                Welcome to Flick N Roll. We respect your privacy and are
              ...
              <p>
                ...
                data about you including identity data, contact data, technical
                data, profile data, usage data, and marketing and communications
                data.
              </p>
              ...
              <p>
                ...
                Most commonly, we will use your personal data to provide our
                services, manage our relationship with you, administer and
                protect our business, and deliver relevant website content and
              ...
              <p>
                ...
                privacy practices, please contact us at privacy@flicknroll.com.
              </p>
            </div>
          </div>
        </div>
